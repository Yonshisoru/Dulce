...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2019 at 08:08 PM
...
('01', 'Buy 1 Free 1', '2018-11-01', '2018-11-30', 'N'),
('02', 'Discount 5% for all!', '2018-10-01', '2018-12-31', 'N');
...
CREATE TABLE `promotion_menu` (
  ...
  `PN_ID` char(4) COLLATE utf8_unicode_ci NOT NULL,
  `MENU_ID` char(4) COLLATE utf8_unicode_ci NOT NULL,
  `PM_DISCOUNT` decimal(2,2) NOT NULL DEFAULT '0.00',
