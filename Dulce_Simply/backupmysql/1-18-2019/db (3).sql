...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2019 at 08:27 PM
...
CREATE TABLE `ordering` (
  ...
  `ORD_PAYTYPE` varchar(6) COLLATE utf8_unicode_ci DEFAULT NULL,
...
('O001', 'E001', '55', '2019-01-18', '30.00', '', 'N');
...
INSERT INTO `order_menu_list` (`OM_ID`, `ORD_ID`, `MENU_ID`, `OM_UNITS`, `OM_PRICE`, `OM_STATUS`, `OM_DEL`) VALUES
(1, 'O001', 'M002', 1, '30.00', 'N', 'N'),
(2, 'O001', 'M002', 1, '0.00', 'N', 'N');
...
('P101', 'V001', 'เมล็ดกาแฟ', '450', '100.000', '01', 1, '04', 'N'),
...
('P151', 'V001', 'นมจืด', '120', '0.000', '09', 2, '04', 'N'),
...
(1, 'P001', '2561-12-13', '2018-12-14', '1.000', '', 'N'),
(2, 'P009', '2561-12-14', '2018-12-14', '1.000', '', 'N'),
(3, 'P009', '2561-12-14', '2018-12-14', '14.000', '', 'N'),
...
(11, 'P101', '2562-01-17', '2019-01-01', '100.000', 'O011', 'N');
...
('W010', 'E001', '08:50:17', '15:58:53', '2018-11-19', '7.0', 'Y', 'N'),
...
--
-- Constraints for table `rep_order`
--
ALTER TABLE `rep_order`
  ADD CONSTRAINT `REP_ORDER_ibfk_1` FOREIGN KEY (`ORD_ID`) REFERENCES `ordering` (`ORD_ID`);
